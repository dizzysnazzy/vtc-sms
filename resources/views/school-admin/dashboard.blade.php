...
{{--  <link rel="stylesheet" type="text/css" href="{{ asset('dash/selectize.css') }}" />--}}
  @stack('js')
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-hospital-o"></i> <span>Academics</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/schooladmin/departments/view"><i class="fa fa-angle-double-right"></i>Departments</a></li>
            <li><a href="/schooladmin/courses/view"><i class="fa fa-angle-double-right"></i> Courses</a></li>
            <li><a href="/schooladmin/levels/view"><i class="fa fa-angle-double-right"></i> Levels</a></li>
            <li><a href="/schooladmin/units/view"><i class="fa fa-angle-double-right"></i> Unit</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/schooladmin/students/enroll"><i class="fa fa-angle-double-right"></i> Enroll Student</a></li>
            <li><a href="/schooladmin/students/view"><i class="fa fa-angle-double-right"></i> View Students</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-bar-chart"></i> <span>Tutors</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/schooladmin/tutor/add"><i class="fa fa-angle-double-right"></i> Add Teacher</a></li>
            <li><a href="/schooladmin/tutor/view"><i class="fa fa-angle-double-right"></i> View Tutors </a></li>
            <li><a href="/schooladmin/tutor/view"><i class="fa fa-angle-double-right"></i> Allocate Units </a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Exams</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/schooladmin/exams/view"><i class="fa fa-angle-double-right"></i> Exam</a></li>
            <li><a href="/schooladmin/exam-rules/view"><i class="fa fa-angle-double-right"></i> Exam Rule</a></li>
            <li><a href="/schooladmin/grading/view"><i class="fa fa-angle-double-right"></i> Grading</a></li>
          </ul>
        </li>

          <li class="treeview">
              <a href="#">
                  <i class="fa fa-edit"></i> <span>Marks &amp; Results</span>
                  <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
              </a>
              <ul class="treeview-menu">
                  <li><a href="/schooladmin/results"><i class="fa fa-angle-double-right"></i> Marks</a></li>
                  <li><a href="/schooladmin/exam-rules/view"><i class="fa fa-angle-double-right"></i> Results Published</a></li>
                  <li><a href="/schooladmin/grading/view"><i class="fa fa-angle-double-right"></i> Grading</a></li>
              </ul>
          </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-angle-double-right"></i> Fee Allocation</a></li>
            <li><a href="#"><i class="fa fa-angle-double-right"></i> Payments </a></li>
            <li><a href="/schooladmin/expenses/view"><i class="fa fa-angle-double-right"></i> Expenses </a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/schooladmin/assets/request"><i class="fa fa-angle-double-right"></i> Acquisition Request</a></li>
            <li><a href="/schooladmin/assets/status"><i class="fa fa-angle-double-right"></i>Acquisition Status</a></li>
          </ul>
        </li>
