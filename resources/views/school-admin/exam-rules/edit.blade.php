    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
                  action="/schooladmin/exam/{{$exam->id}}/edit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="exam_name" value="{{ $exam->exam_name }}" placeholder="e.g End Term/2019" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="exam_period" value="{{ $exam->exam_period}}" placeholder="term/year" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select name="exam_status" id="" class="form-control">
                            <option value="{{$exam->exam_status}}">{{$exam->exam_status}}</option>
